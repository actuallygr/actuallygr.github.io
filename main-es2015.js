...
const routes = [
    ...
    {
        path: 'user',
        loadChildren: () => __webpack_require__.e(/*! import() | features-user-user-module */ "features-user-user-module").then(__webpack_require__.bind(null, /*! ./features/user/user.module */ "./src/app/features/user/user.module.ts")).then(m => m.UserModule)
    },
    {
        path: 'journal',
        loadChildren: () => __webpack_require__.e(/*! import() | features-journal-journal-module */ "features-journal-journal-module").then(__webpack_require__.bind(null, /*! ./features/journal/journal.module */ "./src/app/features/journal/journal.module.ts")).then(m => m.JournalModule)
    },
    {
        path: 'wall',
        loadChildren: () => __webpack_require__.e(/*! import() | features-wall-wall-module */ "features-wall-wall-module").then(__webpack_require__.bind(null, /*! ./features/wall/wall.module */ "./src/app/features/wall/wall.module.ts")).then(m => m.WallModule)
    },
    {
        path: '**',
        redirectTo: 'about'
...
let AppComponent = AppComponent_1 = class AppComponent {
    constructor(store, localStorageService) {
        ...
        this.logo = __webpack_require__(/*! ../../assets/pen.png */ "./src/assets/pen.png");
        this.navigation = [
            { link: 'about', label: 'anms.menu.about' },
            { link: 'user/login', label: 'Log in' }
        ];
        this.authenticatedNavigation = [
            { link: 'wall', label: 'Wall' },
...
const saveToken = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])('[Auth] Token', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["props"])());
...
const selectToken = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createSelector"])(_core_state__WEBPACK_IMPORTED_MODULE_2__["selectAuthState"], (state) => state.token);
...
let RestApiService = class RestApiService {
    constructor(http, store, localStorageService) {
        this.http = http;
        this.store = store;
        this.localStorageService = localStorageService;
        ...
        this.postConfirm = (token) => {
            return this.http.post(this.apiUrl + '/auth/confirm', {
                token
            });
        };
        ...
        this.getAllPosts = () => {
            return this.http.get(this.apiUrl + '/feed/posts', {
                headers: {
                    Authorization: 'Bearer ' + this.localStorageService.getItem('token')
                }
            }).pipe();
        ...
        this.deletePost = (postId) => {
            return this.http.delete(this.apiUrl + '/feed/post/' + postId, {
                headers: {
                    Authorization: 'Bearer ' + this.localStorageService.getItem('token')
                }
            });
        ...
        this.getPost = (postId) => {
            return this.http.get(this.apiUrl + '/feed/post/' + postId, {
                headers: {
                    Authorization: 'Bearer ' + this.localStorageService.getItem('token')
                }
            }).pipe();
        };
        this.putPost = (title, content, postId) => {
            return this.http.put(this.apiUrl + '/feed/post/' + postId, {
                title,
                content
            }, {
                headers: {
...
module.exports = __webpack_require__(/*! J:\IntellijProjects\lyli-ui\src\main.ts */"./src/main.ts");
